...
<ol>
  ...
  <li>API для плагинов
    <ol style="list-style-type: decimal;">
      <li>Методы PluginAPI</li>
      <li>Регистрация команд</li>
      <li>Хуки (banner, info)</li>
      <li>Примеры плагинов
        <ol style="list-style-type: decimal;">
          <li>Плагин с простой командой</li>
          <li>Плагин с хуком баннера</li>
          <li>Плагин с хуком информации</li>
          <li>Плагин с использованием дополнительных библиотек</li>
        </ol>
      </li>
    </ol>
  </li>
  <li>Установка плагинов</li>
  <li>Создание плагинов на C++</li>
  <li>Советы и ограничения</li>
</ol>
