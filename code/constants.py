...
BASE_MINECRAFT_DIR = os.path.join(LAUNCHER_DATA_DIR, "minecraft")
MINECRAFT_DIR = BASE_MINECRAFT_DIR

CONFIG_FILE = os.path.join(LAUNCHER_DATA_DIR, "config.json")
NOTES_FILE = os.path.join(LAUNCHER_DATA_DIR, "notes.txt")
ACCOUNTS_FILE = os.path.join(BASE_MINECRAFT_DIR, "launcher_profiles.json")
...
os.makedirs(BASE_MINECRAFT_DIR, exist_ok=True)
